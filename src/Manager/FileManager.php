...
class FileManager
{
	...
	const NEWKEYS=array('ecole_id' => 'school_id', 'candidat_id' => 'candidate_id', 'nom' => 'name', 'typedoc'=>'docType', 'passage_id'=>'entry_id', 'prof_id' => 'teacher_id');
	...
	// private function setCnx(Connexion $cnx)
	// {
	// 	$this->cnx = $cnx;
	// }
